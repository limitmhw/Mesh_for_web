...
import re
import struct
inputfilepath='normal.obj'
outputfilepath='normal.bin'
vertex_arr=[]
face_arr=[]
uv_arr=[]
...
if __name__ == '__main__':
        ...
        for i in  all_data_arr:
                ...
                if face:
                        f=[]
                        f.append(int(face.group(2)))
                        f.append(int(face.group(3)))
                        f.append(int(face.group(5)))
                        f.append(int(face.group(6)))
                        f.append(int(face.group(8)))
                        f.append(int(face.group(9)))
                        face_arr.append(f)
                if uv:
                        u=[]
